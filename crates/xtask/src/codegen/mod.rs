...
/// `rshooks-core`; see its own module doc comment for why.
pub mod tx_type;
...
pub fn with_generated_marker(inputs: &str, module_doc: &str) -> String {
    format!(
        "// @generated by `cargo xtask gen-core` from crates/rshooks-core/vendor/xahaud-hook/{inputs} — DO NOT EDIT BY HAND.\n{module_doc}"
    )
}
