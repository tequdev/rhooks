// @generated by `cargo xtask gen-core` from crates/hooks-core/vendor/xahaud-hook/hookapi.h, crates/hooks-core/vendor/xahaud-hook/macro.h — DO NOT EDIT BY HAND.
