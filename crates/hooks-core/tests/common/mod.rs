//! Shared parsing/evaluation helpers for hooks-core's vendored-header parity
...
//! `clippy::arithmetic_side_effects`, in the same spirit as `hooks-build`
//! (`docs/DESIGN.md` §8, `crates/hooks-build/src/lib.rs`) — byte-offset
...
/// used throughout `hooks-core`'s translation.
